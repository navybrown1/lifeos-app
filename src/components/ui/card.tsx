...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "relative rounded-2xl border border-border/70 bg-background text-foreground",
        "shadow-[0_1px_4px_rgba(0,0,0,0.06),0_2px_12px_rgba(0,0,0,0.04)]",
        "transition-all duration-300 ease-out",
        "hover:-translate-y-1 hover:shadow-[0_6px_28px_rgba(0,0,0,0.1),0_2px_8px_rgba(0,0,0,0.06)]",
        "hover:border-border",
        className
      )}
      {...props}
